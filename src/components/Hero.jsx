// Hero compoents contains Hero-Section.
...
const Hero = () => {
  ...
  return (
    <div className="hero-container   h-screen flex flex-col items-center justify-center gap-14 bg-light text-center">
      ...
      <form className="flex flex-col md:flex-row items-start md:items-center justify-between p-6 rounded-lg md:rounded-full w-full max-w-80 md:max-w-200 bg-white shadow-[0px_8px_20px_rgba(0,0,0,0.1)]">
        <div className="select-boxes  flex flex-col md:flex-row items-start md:items-center gap-10 min-md:ml-8">
          <div className="select-box-container  flex flex-col items-start gap-2">
            <select
              required
      ...
      <img src={assets.main_car} className="max-h-72" alt="car" />
    </div>
  );
};
