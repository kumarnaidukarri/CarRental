...
const Dashboard = () => {
  ...
  useEffect(() => {
    setData(dummyDashboardData); // updates the state variable
  }, []);
  ...
  return (
    <div className="px-4 pt-10 md:px-10 flex-1">
      <Title
        ...
        subTitle={
          "Monitor overall platform performance including total cars, bookings, revenue, recent activities"
        }
      />
