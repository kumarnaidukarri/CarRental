...
const ManageCars = () => {
  ...
  const fetchOwnerCars = async () => {
    setCars(dummyCarData); // updates the state
  };
  useEffect(() => {
    fetchOwnerCars();
  }, []);
  ...
  return (
    <div className="px4 pt-10 md:px-10 w-full">
      <Title
        title={"Manage Cars"}
        subTitle={
          "View all listed cars, updated their details or remove them from the booking platform."
        }
      />
